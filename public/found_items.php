...
try {
    $stmt = $pdo->query("SELECT f.found_id, u.first_name, u.last_name, c.category_name, f.item_name, f.description, f.date_found, f.place_found, f.status
                         FROM found_items f
...
<head>
    ...
    <style>
        ...
        /* Button same color as lost item page and centered */
        .add-btn {
            display: inline-block;
            padding: 10px 18px;
            background-color: #ff4d4d; /* match lost item button color */
            color: white;
